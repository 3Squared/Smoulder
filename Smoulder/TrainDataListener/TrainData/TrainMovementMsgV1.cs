...
{
    [XmlRoot(ElementName = "TrainMovementMsgV1", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
    public class TrainMovementMsgV1 : TrustMessageData
    {
        [XmlElement(ElementName = "Sender", Namespace = "http://xml.networkrail.co.uk/ns/2008/EAI")]
        public Sender Sender { get; set; }

        [XmlElement(ElementName = "TrainMovementData", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
        public TrainMovementData TrainMovementData { get; set; }
