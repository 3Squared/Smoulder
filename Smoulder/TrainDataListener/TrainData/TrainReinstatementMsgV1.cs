...
{
    [XmlRoot(ElementName = "TrainReinstatementMsgV1", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
    public class TrainReinstatementMsgV1:TrustMessageData
    {
        [XmlElement(ElementName = "Sender", Namespace = "http://xml.networkrail.co.uk/ns/2008/EAI")]
        public Sender Sender { get; set; }

        [XmlElement(ElementName = "TrainReinstatementData", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
        public TrainReinstatementData TrainReinstatementData { get; set; }
