...
{
    [XmlRoot(ElementName = "TrainChangeIdentityMsgV1", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
    public class TrainChangeIdentityMsgV1 : TrustMessageData
    {
        [XmlElement(ElementName = "Sender", Namespace = "http://xml.networkrail.co.uk/ns/2008/EAI")]
        public Sender Sender { get; set; }

        [XmlElement(ElementName = "TrainChangeIdentityData", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
        public TrainChangeIdentityData TrainChangeIdentityData { get; set; }
