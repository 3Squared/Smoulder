...
{
    [XmlRoot(ElementName = "TrainChangeLocationMsgV1", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
    public class TrainChangeLocationMsgV1 : TrustMessageData
    {
        [XmlElement(ElementName = "Sender", Namespace = "http://xml.networkrail.co.uk/ns/2008/EAI")]
        public Sender Sender { get; set; }

        [XmlElement(ElementName = "TrainChangeLocationData", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
        public TrainChangeLocationData TrainChangeLocationData { get; set; }
