...
{
    [XmlRoot(ElementName = "TrainCancellationMsgV1", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
    public class TrainCancellationMsgV1 : TrustMessageData
    {
        [XmlElement(ElementName = "Sender", Namespace = "http://xml.networkrail.co.uk/ns/2008/EAI")]
        public Sender Sender { get; set; }

        [XmlElement(ElementName = "TrainCancellationData", Namespace = "http://xml.networkrail.co.uk/ns/2008/Train")]
        public TrainCancellationData TrainCancellationData { get; set; }
